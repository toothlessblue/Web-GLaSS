...
RenderPipeline::RenderPipeline() {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA16F, WebGLaSS::screen.width, WebGLaSS::screen.height, 0, GL_RGBA, GL_FLOAT, NULL);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, WebGLaSS::screen.width, WebGLaSS::screen.height, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, WebGLaSS::screen.width, WebGLaSS::screen.height);  
